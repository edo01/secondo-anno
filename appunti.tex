...
\begin{itemize}
    \item \textbf{Partizioni fisse (MFT, Multiprogramming with Fixed number of Tasks}: La memoria fisica disponibile per lallocazione dei processi è suddivisa a priori
     ...
     Per la gestione di questo overhead esistono più politiche: \textbf{first fit}, viene scelto il primo spazio disponibile per il processo a favore della velocità e della 
